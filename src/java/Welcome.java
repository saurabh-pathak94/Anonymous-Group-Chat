...
public class Welcome extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<h2>Welcome, "+name+"</h2><i>Chat logs</i>");
        //access chat records
        //String filePath = "C:\\Users\\Acer\\Documents\\NetBeansProjects\\servlet_test\\src\\java\\DBServer.java";
        
        try{
            //Generate Random port number
             Random rand = new Random();
             int min=49152,max=65535;
